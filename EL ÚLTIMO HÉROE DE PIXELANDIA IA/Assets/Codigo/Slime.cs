...
public class ControlesEnemigos : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            // La dirección del daño se basa en la posición de la espada.
    ...
    public void RecibeDanio(Vector2 direccion, int cantDanio)
    {
        if (!recibiendoDanio)
        {
            ...
            {
                // Calcula el vector de rebote después de recibir daño.
    ...
    IEnumerator DesactivaDanio()
    {
        ...
        rb.linearVelocity = Vector2.zero; // Detiene el movimiento del hongo después del rebote.
    }
